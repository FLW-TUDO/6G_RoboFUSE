...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_share, 'config', 'follower_nav2_params.yaml'),
    ...
    # Add the follower node to launch the script for ep03
    follower_node = Node(
    ...
    bringup_cmd_group = GroupAction([
        ...
        follower_node  # Add the follower node to the bringup group
    ])
